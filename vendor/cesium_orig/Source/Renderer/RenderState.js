...
define([
    ...
    function validateDepthFunction(depthFunction) {
        return ((depthFunction === WebGLRenderingContext.NEVER) ||
                (depthFunction === 0x0201 // WebGLRenderingContext.LESS) ||
    ...
    function validateStencilFunction (stencilFunction) {
        return ((stencilFunction === WebGLRenderingContext.NEVER) ||
                (stencilFunction === 0x0201 // WebGLRenderingContext.LESS) ||
    ...
    var RenderState = function(context, renderState) {
        ...
        this.depthTest = {
            ...
            func : defaultValue(depthTest.func, 0x0201 // WebGLRenderingContext.LESS) // func, because function is a JavaScript keyword
        };
        this.colorMask = {
